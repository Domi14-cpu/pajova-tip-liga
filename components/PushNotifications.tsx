...
export default function PushNotifications() {
  ...
  useEffect(() => {
    async function checkPushStatus() {
      ...
      try {
        ...
        console.error(
          "Kontrola push notifikací selhala:",
          error
        );
      } finally {
        setLoading(false);
  ...
  async function enablePushNotifications() {
    ...
    try {
      ...
      if (!user) {
        setMessage(
          "Pro zapnutí upozornění se musíš přihlásit."
        );
        return;
      }
      ...
      if (!p256dh || !auth) {
        throw new Error(
          "Push subscription neobsahuje potřebné klíče."
        );
      }
      ...
      setMessage(
        "Push upozornění jsou zapnutá."
      );
    } catch (error) {
      console.error(
        "Zapnutí push notifikací selhalo:",
        error
      );
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="font-black">
              Push upozornění nejsou podporována
            </p>
